...
export default function Home() {
  ...
  const { data: events, isLoading, isError } = useEvents({
    ...
    limit: ITEMS_PER_PAGE * (page + 1) // Just fetch more items locally for simplicity or pass offset
  })
  ...
  // Filter events locally by city and category to avoid complex PG PostGIS queries for MVP
