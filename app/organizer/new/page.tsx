...
export default function CreateEventPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      const { data: newEvent, error } = await eventsTable.insert({
          ...data,
  ...
  if (!user) {
    return <div className="p-12 text-center text-zinc-500">Please log in as an organizer.</div>
  }
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-6 md:p-12">
      <div className="mx-auto max-w-3xl space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">Create New Event</h1>
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Fill out the details below to host your next event.</p>
        </div>
